...
const menu = [
 {
    ...
    desc: `High quality matcha with dairy-free milk alternatives. You can choose from either oat, soy, almond or coconut milk`,
 },
 {
   id: 2,
   title:"Matcha Tart",
...
},
{
   ...
   desc: `Vegan french toast bread toasted golden brown topped with vegan ice cream and fruits. Optional toppings: vegan cream and agave syrup toppings.`,
},
{
   id: 5,
...
},
{
   ...
   desc: `Vegan banana donut is made with ripe banana, dark chocolate and vegan cream. Comes with chocolate ganache and toppings`,
},
{
   id: 8,
...
},
{
   ...
   desc: `Strawberry milk is made of fresh organic strawberry jam handmade with oatmilk and a dash of vanilla extract. Perfect afternoon pairing with a slice of cake. `,
},
{
   id: 11,
   ...
   price:4.50,
   img:"./images/vegan-strawberrymilk.jpg",
   desc: `Fresh Mango crumble made with vegan crustard and shortbread dough base. Comes with fresh cutted mango on top, custard and vegan whipped cream. `,
},
{
   id: 12,
